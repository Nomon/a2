...
TokenService.prototype.exchangeGrantForToken = function(grant, callback) {
  var userId = grant.user_id;
  var clientId = grant.client_id;
  var code = grant.code;
  var scopes = grant.scopes;
  this.createOrFind(userId, clientId, scopes, function(err, token) {
