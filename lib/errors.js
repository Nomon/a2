...
exports.invalid_client = function (req, res) {
  var error = {
    error: "invalid_client", error_description: "The client is not authorized to request an authorization code using this method."
  };
};
...
exports.unsupported_response_type = function () {
  var error = {
    error: "", error_description: "The authorization server does not support obtaining an " +
...
exports.server_error = function () {
  var error = {
    error: "", error_description: "The authorization server encountered an unexpected " +
